...
do_hide() {
    ...
    # Ein Sound fuer die GANZE Aktion (nicht pro Fenster) - "alle Fenster
    # verstecken" ist konzeptionell eine Aktion, auch wenn intern pro
    # Fenster einzeln hyprland-minimizer aufgerufen wird. Nutzt denselben
    # "Minimize"-Sound wie WaybarClicks.sh' Rechtsklick-Minimieren, da
    # beide dasselbe hyprland-minimizer-Binary ausloesen.
    bash "$HOME/.config/hypr/SoundCenter.sh" Minimize &
}
