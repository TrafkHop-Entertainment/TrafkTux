#!/usr/bin/env python3
"""
WidgetsClient.py — thin client for WidgetsDaemon.py
...
Usage:  python3 WidgetsClient.py <widget>
Example Waybar config:
  "on-click": "python3 /path/to/WidgetsClient.py volume"
"""
import os
import socket
import sys
...
def main() -> int:
    if len(sys.argv) != 2:
        print("Usage: WidgetsClient.py <widget>", file=sys.stderr)
        return 1
    widget = sys.argv[1]
