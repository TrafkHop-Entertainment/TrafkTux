...
if not f then return default end
    ...
    if content == nil or content == "" then return default end
        ...
        hl.exec_cmd("cp ~/.config/rofi/assets/TrafkBubble1.png /tmp/TrafkBubbleGlow1.png")
        hl.exec_cmd("cp ~/.config/rofi/assets/TrafkBubble2.png /tmp/TrafkBubbleGlow2.png")
